...
private:
  ...
  Thread *mRadioRxDriveLoopThread;  ///< thread to push/pull bursts into transmit/receive FIFO
...
protected:
  ...
  */
  ...
  friend void *RadioRxDriveLoopAdapter(DriveLoop *);
...
void *RadioRxDriveLoopAdapter(DriveLoop *);
